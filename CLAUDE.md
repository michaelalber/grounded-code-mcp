...
| 2026-05 | Removed `langchain`, `langgraph`, and `langsmith` collections | All three are well-covered by model training data; static snapshots create drift with fast-moving docs. |
